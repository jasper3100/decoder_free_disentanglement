...
class PUG_Imagenet(datasets.base.DisentangledDataset):
    ...
    # we omit the latent variable 'character_name' because it can take 724 values, which 
    # is a lot and drastically slows down the computation of the evaluation metric DCI-D
    # This variable is slightly redundant anyways because there is a mapping of the 724 objects
    # to the 151 classes ('character_label').
    lat_names = ('world_name', 'character_label', 'character_rotation_yaw', 'character_rotation_roll', 'character_rotation_pitch', 'character_scale', 'camera_roll', 'camera_pitch', 'camera_yaw', 'character_texture', 'scene_light')
    # see p. 20 of [1]
    ...
    # they have 7 (due to "Default" as additional value), likewise 'scene_light' has 8 instead of the
    # official 7 values     
