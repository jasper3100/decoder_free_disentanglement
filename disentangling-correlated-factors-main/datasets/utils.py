...
COLOUR_WHITE = 1
DATASETS = [
    'mnist', 'fashionmnist', 'dsprites', 'celeba', 'chairs', 'shapes3d', 'mpi3d', 'mpi3d_real', 'mpi3d_real_complex', 'cars3d', 'smallnorb', 'pug_animals', 'pug_spar', 'pug_imagenet'
]
...
def get_dataset(dataset):
    ...
    if dataset == 'pug_spar':
        import datasets.pug_spar
        return datasets.pug_spar.PUG_Spar
    if dataset == 'pug_animals':
        import datasets.pug_animals
        return datasets.pug_animals.PUG_Animals
    if dataset == 'pug_imagenet':
        import datasets.pug_imagenet
        return datasets.pug_imagenet.PUG_Imagenet
