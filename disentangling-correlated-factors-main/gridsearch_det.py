...
USER = os.getenv('USER', 'aoq918')# 'karroth')
#DEFAULT_SLURMDIR = os.getenv('SLURMDIR', '/checkpoint/' + USER + '/jobs')
DEFAULT_SLURMDIR = os.getenv('SLURMDIR', '/mnt/qb/work/akata/aoq918/disentangling-correlated-factors-main/jobs')

# I added this line
os.environ['WANDB_API_KEY'] = '26abc29a9b78f01f65b5249f39ee020cee612598'
...
parser.add_argument('--partition', '-p', type=str, default='gpu-2080ti-preemptable') # default='learnlab')
...
parser.add_argument('--timeout_min', '-to', type=int, default=4300) #previously: 300 #upper-bounded by #SBATCH --time=D-HH:MM in the gridsearch file
parser.add_argument('--max_parallel_jobs', '-mpj', type=int, default=25)
...
executor.update_parameters(
    ...
    slurm_array_parallelism=args.max_parallel_jobs #25
)
